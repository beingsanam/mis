...
if(isset($_POST['order_btn'])){
   ...
   $detail_query = mysqli_query($conn, "INSERT INTO `order`(name, number, email, method, house_no, city, street,state,country, pin_code ) VALUES('$name','$number','$email','$method','$house_no','$city','$street','$state','$country','$pin_code')") or die('query failed');
